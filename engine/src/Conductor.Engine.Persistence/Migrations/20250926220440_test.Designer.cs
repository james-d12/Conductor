...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.Application.Domain.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.Deployment.Domain.Deployment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.Environment.Domain.Environment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.ResourceTemplate.Domain.ResourceTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.Application.Domain.Application", b =>
                {
                    b.OwnsOne("Conductor.Engine.Domain.Application.Domain.Repository", "Repository", b1 =>
                        {
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.Deployment.Domain.Deployment", b =>
                {
                    b.HasOne("Conductor.Engine.Domain.Application.Domain.Application", null)
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Conductor.Engine.Domain.Environment.Domain.Environment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Conductor.Engine.Domain.ResourceTemplate.Domain.ResourceTemplate", b =>
                {
                    b.OwnsMany("Conductor.Engine.Domain.ResourceTemplate.Domain.ResourceTemplateVersion", "Versions", b1 =>
                        {
                            ...
                            b1.OwnsOne("Conductor.Engine.Domain.ResourceTemplate.Domain.ResourceTemplateVersionSource", "Source", b2 =>
                                {
